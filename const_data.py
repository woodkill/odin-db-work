...
cDIC_BOSS_INFO = {
    ...
    '005':{kCHAP_ORDER: 0, kCHAP_NAME: u'던전', kBOSS_LEVEL:'지배자', kBOSS_ORDER:3, kBOSS_TYPE:cBOSS_TYPE_INTERVAL, kBOSS_INTERVAL: '00:36:00', kBOSS_NAME: u'10층흘로크'     , kBOSS_ALIAS: [u'기만의기사다인흘로크', u'10층흘로크', u'10층', u'흘로크']},
    # 성채
